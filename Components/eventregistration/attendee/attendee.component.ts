...
export class AttendeeComponent implements OnInit {
    ...
    // @ViewChild('firstName') firstName: ElementRef; Changing to below line for upgrade support 
    ...
    public confirmEdit(form: NgForm): void {
        ...
        this.attendee.pass = (this.passes || []).find((pass) => pass.passId === this.attendee.passId);
